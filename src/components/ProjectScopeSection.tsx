  ...
  const features = [
    {
      ...
      desc:
        lang === 'es'
          ? '530 sq ft de área neta más factor de desperdicio calculado para optimizar la compra de materiales y minimizar costos.'
          : '530 sq ft net area plus calculated waste factor to optimize material purchases and minimize project costs.',
    },
    {
    ...
    },
    {
      ...
      desc:
        lang === 'es'
          ...
          : 'Precision laser-guided installation across 530 sq ft with expansion margins and click-lock integrity.',
    },
    {
      step: '03',
